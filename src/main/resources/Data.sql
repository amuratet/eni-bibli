...
--Elijah Wood, Ian McKellen, Sean Astin,
--Marlon Brando, Martin Sheen, Robert Duvall,
--Malcolm McDowell, Patrick Magee, Michael Bates,
--Cédric Dumond, Virginie Mery, Catherine Sola,
...
('Pulp Fiction', 1994, 154, 'L''odyssée sanglante, burlesque et cocasse de petits malfrats dans la jungle de Hollywood à travers trois histoires qui s''entremêlent.', 10, 3),
...
('The Dark Knight - Le Chevalier noir', 2008, 152, 'Avec l''appui du lieutenant de police Jim Gordon et du procureur de Gotham, Harvey Dent, Batman vise à éradiquer le crime organisé qui pullule dans la ville. Leur association est très efficace, mais elle sera bientôt bouleversée par le chaos déclenché par un criminel psychopathe que les citoyens de Gotham connaissent sous le nom de Joker.', 33, 4),
...
('Interstellar', 2014, 169, 'Un groupe d''explorateurs exploite une faille dans l''espace-temps afin de parcourir des distances incroyables dans le but de sauver l''humanité.', 37, 4),
...
('Le Bon, la Brute et le Truand', 1966, 179, 'Un chasseur de primes rejoint deux hommes dans une alliance précaire. Leur but ? Trouver un coffre rempli de pièces d''or dans un cimetière isolé.', 30, 10),
...
('Le Seigneur des Anneaux : La Communauté de l''anneau ', 2001, 178, 'Frodon reçoit l''Anneau de son oncle Bilbo. Sa vie et son monde sont pourtant en danger, car cet anneau appartient à Sauron, le maître des ténèbres.', 31, 9),
('Apocalypse Now', 1979, 147, 'Durant la guerre du Viêt-nam, le capitaine Willard est contraint de mener une mission périlleuse au Cambodge. Accompagné de quatre soldats, il doit mettre fin au commandement du colonel Kurtz, qui utilise des méthodes jugées trop barbares.', 25, 7),
...
('Princesse Mononoké', 1997, 134, 'Ashitaka est à la recherche d''un remède à la malédiction de Tatarigami. Il se retrouve au milieu d''une guerre entre les dieux de la Forêt et Tatara.', 13, 11),
...
('Old Boy', 2003, 120, 'Après avoir été enlevé et emprisonné durant 15 ans, sans savoir pourquoi, Oh Dae-Su est libéré et recherche les raisons de son enfermement.', 17, 13),
...
('Le Voyage de Chihiro', 2001, 125, 'Lors du déménagement de sa famille, Chihiro, une fillette de 10 ans, erre dans un monde régi par les dieux, sorcières et monstres.', 29, 11);
