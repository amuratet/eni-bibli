...
('Pulp Fiction', 1994, 154, 'L''odyssée sanglante, burlesque et cocasse de petits malfrats dans la jungle de Hollywood à travers trois histoires qui s''entremêlent.'),
...
('Le Seigneur des Anneaux : Le Retour du roi', 2003, 191, ''),
('The Dark Knight - Le Chevalier noir', 2008, 152, 'Avec l''appui du lieutenant de police Jim Gordon et du procureur de Gotham, Harvey Dent, Batman vise à éradiquer le crime organisé qui pullule dans la ville. Leur association est très efficace, mais elle sera bientôt bouleversée par le chaos déclenché par un criminel psychopathe que les citoyens de Gotham connaissent sous le nom de Joker.');
